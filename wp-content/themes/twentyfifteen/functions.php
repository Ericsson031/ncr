...
/* Admin editor custom js */
function load_editor_js() {
    if ( 'edit.php' == $hook ) {
        return;
    }    
    wp_enqueue_script( 'jquite_light', get_template_directory_uri() . '/js/jquitelight.js', array( 'jquery' ));
    wp_enqueue_script( 'custom_admin', get_template_directory_uri() . '/js/custom_admin.js', array( 'jquery' ));
    wp_enqueue_style( 'custom_admin', get_template_directory_uri() . '/css/custom_admin.css');
}
add_action( 'admin_enqueue_scripts', 'load_editor_js' ); 
